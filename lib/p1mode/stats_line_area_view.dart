...
class StatsLineAreaView extends StatefulWidget {
  ...
  StatsLineAreaView({required this.datas});
...
class _StatsLineAreaViewState extends State<StatsLineAreaView> {
  ...
  Widget build(BuildContext context) {
    return widget.datas.length > 0
      ...
      series: <CartesianSeries<Trainingtimemodel, String>>[
        AreaSeries(
            ...
            pointColorMapper: (Trainingtimemodel data, _) => Color.fromRGBO(233,100,21,1.0),
            xValueMapper: (Trainingtimemodel data, _) => data.time,
            yValueMapper: (Trainingtimemodel data, _) => double.parse(data.pickupBallTime)),
